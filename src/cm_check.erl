...
perform_type_checks(SearchPath, SourceList, DepGraph, Opts) ->
    ...
    {DepsChanged, NewIndex0} = cm_index:has_external_dep_changed(RebarLockFile, Index),
    NewIndex1 = cm_index:prune(NewIndex0, SourceList),
...
run_checks_and_save(CheckList, SearchPath, Opts, Index, IndexFile) ->
    ...
    Symtab = symtab:std_symtab(SearchPath, OverlaySymtab, paths:std_symtab_file_name(Opts)),
