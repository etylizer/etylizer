...
-define(REPORT_THRESHOLD_MS, 50).

-ifdef(debug).
-define(SANITY(Name, X), (fun() -> __Start = erlang:system_time(), X, __Time = (erlang:system_time() - __Start)/1000000, case __Time > ?LOG_THRESHOLD_MS of true -> ?LOG_INFO("Sanity ~p finished in ~.1f ms", Name, __Time); _ -> ok end end)()).
