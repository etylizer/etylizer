...
-export([s_interval/0, s_intersect/2, s_union/2, s_negate/1, s_any/0, s_empty/0, s_map/0, s_predef/1, s_variable/1, s_atom/1, s_interval/1, s_tuple/2, s_map/1, s_list/1, s_tuple/0, s_function/0]).
