...
% invariants
-etylizer({disable_exhaustiveness_toplevel, [tuple_to_map/1]}).
...
unparse_any_module(dnf_ty_list, {predef, any}) -> {improper_list, {predef, any}, {predef, any}}; % TODO double-check
