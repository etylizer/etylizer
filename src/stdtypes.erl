...
expand_predef_alias(binary) -> errors:not_implemented(binary); %% TODO
expand_predef_alias(nonempty_binary) -> errors:not_implemented(binary); %% TODO
expand_predef_alias(bitstring) -> errors:not_implemented(bitstring); %% TODO
expand_predef_alias(nonempty_bitstring) -> errors:not_implemented(bitstring); %% TODO
...
expand_predef_alias(Name) ->
    ...
    errors:not_implemented({"expand_predef_alias", Name}).
