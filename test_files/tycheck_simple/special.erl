...
-etylizer({disable_exhaustiveness_toplevel, [error01_e_fail/1, error06/1, error08_fail/1]}).
-etylizer({disable_exhaustiveness, [error11/1]}).
...
% * The interaction with -etylizer({disable_exhaustiveness_toplevel, ...}) is as follows:
