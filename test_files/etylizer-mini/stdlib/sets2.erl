...
-etylizer({functions_exhaustive, off, [intersection_heuristic/6, intersection_decided/3, subtract_heuristic/6]}).
-etylizer({functions_exhaustive, off, [new/1, from_list/2, rehash/4, subtract_decided/3]}).
