...
% LLM GENERATED SPECS
-spec lookup_1(Key, gb_tree_node(Key, Value)) -> 'none' | {'value', Value}.
-spec is_defined_1(Key, gb_tree_node(Key, _Value)) -> boolean().
-spec get_1(Key, gb_tree_node(Key, Value)) -> Value.
-spec update_1(Key, Value, gb_tree_node(Key, Value)) -> gb_tree_node(Key, Value).
-spec insert_1(Key, Value, gb_tree_node(Key, Value), non_neg_integer()) -> 
    gb_tree_node(Key, Value) | {gb_tree_node(Key, Value), integer(), integer()}.
-spec count(gb_tree_node(_Key, _Value)) -> {integer(), integer()}.
-spec balance(gb_tree_node(Key, Value), non_neg_integer()) -> gb_tree_node(Key, Value).
-spec balance_list([{Key, Value}], non_neg_integer()) -> gb_tree_node(Key, Value).
-spec balance_list_1([{Key, Value}], non_neg_integer()) -> {gb_tree_node(Key, Value), [{Key, Value}]}.
-spec delete_1(Key, gb_tree_node(Key, Value)) -> gb_tree_node(Key, Value).
-spec merge(gb_tree_node(Key, Value), gb_tree_node(Key, Value)) -> gb_tree_node(Key, Value).
-spec take_1(Key, gb_tree_node(Key, Value)) -> {Value, gb_tree_node(Key, Value)}.
-spec take_smallest1(gb_tree_node(Key, Value)) -> {Key, Value, gb_tree_node(Key, Value)}.
-spec smallest_1(gb_tree_node(Key, Value)) -> {Key, Value}.
-spec take_largest1(gb_tree_node(Key, Value)) -> {Key, Value, gb_tree_node(Key, Value)}.
-spec largest_1(gb_tree_node(Key, Value)) -> {Key, Value}.
-spec smaller_1(Key, gb_tree_node(Key, Value)) -> none | {Key, Value}.
-spec larger_1(Key, gb_tree_node(Key, Value)) -> none | {Key, Value}.
-spec to_list_1(gb_tree_node(Key, Value)) -> [{Key, Value}].
-spec to_list(gb_tree_node(Key, Value), [{Key, Value}]) -> [{Key, Value}].
-spec keys(gb_tree_node(Key, _Value), [Key]) -> [Key].
-spec values(gb_tree_node(_Key, Value), [Value]) -> [Value].
-spec iterator_1(gb_tree_node(Key, Value), [gb_tree_node(Key, Value)]) -> [gb_tree_node(Key, Value)].
-spec iterator_r(gb_tree_node(Key, Value), [gb_tree_node(Key, Value)]) -> [gb_tree_node(Key, Value)].
-spec iterator_from_1(Key, gb_tree_node(Key, Value), [gb_tree_node(Key, Value)]) -> [gb_tree_node(Key, Value)].
-spec iterator_from_r(Key, gb_tree_node(Key, Value), [gb_tree_node(Key, Value)]) -> [gb_tree_node(Key, Value)].
-spec map_1(fun((Key, Value1) -> Value2), gb_tree_node(Key, Value1)) -> gb_tree_node(Key, Value2).
